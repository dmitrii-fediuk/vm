...
// @grant GM_addStyle
// @homepageURL https://github.com/dmitrii-fediuk/vm/blob/main/s/Google/Developers.js
// @icon https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_"G"_logo.svg
// @match https://developers.google.com/*
// @name Google / Developers
// ==/UserScript==
// 2026-05-31 "Improve `developers.google.com`": https://github.com/dmitrii-fediuk/vm/issues/128
// language=CSS
GM_addStyle([
]
	 // language=Javascript
...
GM_addStyle([
	...
	,`devsite-feature-tooltip` // 2026-05-31
...
GM_addStyle([
	...
	.join(',') + '{' +
		...
		Object.entries({
			// language=CSS
			'color': '#067D17' // 2026-05-31
			,'font-weight': 'bold' // 2026-05-31
		}).map(([k, v]) => `${k}: ${v} !important;`).join(' ') +
	'}'
);
// 2026-05-31
