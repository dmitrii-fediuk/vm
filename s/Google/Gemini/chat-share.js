...
// 2025-12-21 It removes the duplicate vertical scrollbar in the Chat Mode.
if (1) {
	// 2025-03-28
	// 2025-12-21
	// «'height': 'auto'» for these elements:
	// 		1) Breaks the Partial Share
	// 		2) Unnecessary
	// language=CSS
	GM_addStyle([
