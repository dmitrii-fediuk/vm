...
// ==/UserScript==
// 2024-08-07
// 1) "Prevent the header from sticking on `trustpilot.com`":
// https://github.com/dmitrii-fediuk/vm/issues/20
// 2) "Hide the right sidebar from `trustpilot.com`": https://github.com/dmitrii-fediuk/vm/issues/21
...
GM_addStyle([
	...
	,`[class^='styles_helpCenterLink']` // 2026-04-13
	,`[class^='styles_stickyColumnContent']` // 2026-04-13
	,`[class^='styles_summaryContainer']` // 2026-04-13
	,`[class^='styles_trustpilotExperienceCardContainer']` // 2026-04-13
	,`footer` // 2026-04-13
